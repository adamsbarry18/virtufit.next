...
const SuggestOutfitColorsOutputSchema = z.object({
  ...
  explanation: z.string().describe('An explanation of why these colors are complementary.'),
});
export type SuggestOutfitColorsOutput = z.infer<typeof SuggestOutfitColorsOutputSchema>;

export async function suggestOutfitColors(
  input: SuggestOutfitColorsInput
): Promise<SuggestOutfitColorsOutput> {
