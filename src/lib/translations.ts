export const translations = {
  en: {
    ...
    uploadSubtitle: 'Upload a clear, front-facing photo for best results.',
    ...
    colorSuggestionTitle: 'Color Suggestions for',
    explanation: "Here's why these colors work:",
  ...
  fr: {
    ...
    errorGeneratingImage: "Impossible de générer l'image. Veuillez réessayer.",
    ...
    colorSuggestionTitle: 'Suggestions de couleurs pour',
    explanation: 'Voici pourquoi ces couleurs fonctionnent :',
    complementaryColors: 'Couleurs complémentaires :',
    close: 'Fermer',
