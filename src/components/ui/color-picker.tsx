...
const predefinedColors = [
  ...
  // Rouges
  '#FF0000', '#FF6B6B', '#FF8E8E', '#DC143C', '#B22222',
  // Bleus
  '#0000FF', '#4169E1', '#6495ED', '#87CEEB', '#1E90FF',
  // Verts
  '#00FF00', '#32CD32', '#90EE90', '#00FA9A', '#00CED1',
  // Jaunes/Oranges
  '#FFFF00', '#FFD700', '#FFA500', '#FF8C00', '#FF7F50',
  // Violets/Roses
  '#800080', '#9932CC', '#DA70D6', '#FF69B4', '#FF1493',
  // Marrons/Terres
  '#A52A2A', '#D2691E', '#CD853F', '#DEB887', '#F4A460',
  // Couleurs tendance
  '#E6E6FA', '#F0F8FF', '#FFEFD5', '#F5FFFA', '#FFF8DC',
];
